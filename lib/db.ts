...
export const getActiveNotifications = NotificationService.getActiveNotifications
...
export const saveNotification = NotificationService.saveNotification
...
export const markNotificationAsRead = NotificationService.markAsRead // Adicionar esta exportação como alias
export const markAllNotificationsAsRead = NotificationService.markAllAsRead // Adicionar esta exportação
